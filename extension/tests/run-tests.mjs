...
import { runPatchInstallerTests } from "./patch-installer.test.mjs";
import { runPatchRegistryTests } from "./patch-registry.test.mjs";
...
import { runInfraRuntimeTests } from "./infra-runtime.test.mjs";
import { runNavigationPatchTests } from "./navigation-patches.test.mjs";
import { runAppInitEventTests } from "./app-init-events.test.mjs";
import { runSquadBuilderPatchTests } from "./squad-builder-patches.test.mjs";
import { runRewardFutbinButtonTests } from "./reward-futbin-button.test.mjs";
...
function assertUserscriptBundle() {
  ...
  assert.ok(userscript.includes("Patch phase failed"));
...
runPatchInstallerTests();
runPatchRegistryTests();
runNavigationPatchTests();
runAppInitEventTests();
runSquadBuilderPatchTests();
runRewardFutbinButtonTests();
